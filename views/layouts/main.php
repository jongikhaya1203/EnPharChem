...
<aside class="sidebar" id="sidebar">
    ...
    <a href="/enpharchem/control-panel/module-licenses" class="nav-link"><i class="fas fa-shield-alt"></i>Module Licenses</a>
    <a href="/enpharchem/control-panel/formulae" class="nav-link"><i class="fas fa-calculator"></i>Formulae Sheets</a>
